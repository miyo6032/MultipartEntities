...
public class MultipartEntitiesClient implements ClientModInitializer {
    ...
    public void onInitializeClient() {
        EntityRendererRegistry.INSTANCE.register(MultipartEntities.TEST_ENTITY_TYPE, (entityRenderDispatcher, context) -> new EntityRenderer<TestEntity>(entityRenderDispatcher) {
            @Override
